...
/* harmony import */ var _assets_javascripts_modal__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./assets/javascripts/modal */ "./src/assets/javascripts/modal.js");
...
var filter;
var articles;
var sortBy = 'desc'; //pour trier (récent ou ancien)
...
var createArticles = function createArticles() {
  ...
  var articlesDOM = articles.filter(function (article) {
    ...
    var articleDOM = document.createElement("div"); //création div
  ...
  articleContainerElement.append.apply(articleContainerElement, _toConsumableArray(articlesDOM)); //pour rendre le bouton supprimer actif

  var deleteButtons = articleContainerElement.querySelectorAll(".btn-danger"); //on récupère tous les boutons supprimer
  //action
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return Object(_assets_javascripts_modal__WEBPACK_IMPORTED_MODULE_23__["openModal"])('Etes-vous sûr de vouloir supprimer cet article ?');
              ...
              case 2:
                ...
                _context.prev = 4;
                target = event.target;
                articleId = target.dataset.id; //fetch

                _context.next = 9;
                return fetch("https://jsonplaceholder.typicode.com/posts/arnaud-blog/".concat(articleId), {
  ...
  var editButtons = articleContainerElement.querySelectorAll(".btn-primary"); //on récupère tous les boutons modifier
...
var displayMenuCategories = function displayMenuCategories(categoriesArr) {
  var lieElements = categoriesArr.map(function (categoryElem) {
    ...
    li.addEventListener('click', function () {
      if (filter === categoryElem[0]) {
        ...
        lieElements.forEach(function (li) {
          //on retire la classe active partout avant de sélectionner la nouvelle
          li.classList.remove('active');
        });
  ...
  categoriesContainerElement.append.apply(categoriesContainerElement, _toConsumableArray(lieElements));
...
var createMenuCategories = function createMenuCategories() {
  ...
  var categoriesArr = Object.keys(categories).map(function (category) {
    ...
    //tri par ordre alphabétique des catégories
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return fetch("https://jsonplaceholder.typicode.com/posts/arnaud-blog?sort=createdAt:".concat(sortBy));
