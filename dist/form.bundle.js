...
/* harmony import */ var _assets_javascripts_modal__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./../assets/javascripts/modal */ "./src/assets/javascripts/modal.js");
...
var form = document.querySelector("form"); //on récupère les données du formulaire

var errorElement = document.querySelector("#errors"); //on récupère les erreurs

var btnCancel = document.querySelector(".btn-secondary"); //on récupère le bouton Annuler

var errors = []; //les erreurs sont colligés dans un tableau vide

var articleId; //pour modifier un article, récupérer chaque élément déjà rentré
  ...
  return regeneratorRuntime.wrap(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return Object(_assets_javascripts_modal__WEBPACK_IMPORTED_MODULE_12__["openModal"])('Si vous quittez la page, vous allez perdre votre article.');
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            formData = new FormData(form); //transforme en données pour envoie en JSON après

            article = Object.fromEntries(formData.entries()); //récupération des entrées/données + création d'un objet avec ces données
            ...
            _context3.prev = 4;
            json = JSON.stringify(article); //transformation au format JSON pour envoi au serveur
          ...
          case 12:
            _context3.next = 14;
            return fetch("https://jsonplaceholder.typicode.com/posts/arnaud-blog", {
              method: "POST",
              //fetch d'envoi
              body: json,
              headers: {
          ...
          case 15:
            ...
            if (response.status < 300) {
              //on redirige l'utilisateur si status ok
              location.assign('/index.html');
            }
...
var formIsValid = function formIsValid(article) {
  ...
  if (!article.author || !article.image || !article.category || !article.content || !article.title) {
